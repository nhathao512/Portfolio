export const Project = () => {
  const projects = [
    ...
    },
    {
      ...
      githubLink:
        "https://github.com/nhathao512/Simulated-Email-Service-Application",
      featured: false,
    },
    {
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-blue-400 mb-3">Projects</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.map((project, index) => (
          <div
            key={index}
            className={`bg-gray-700/50 backdrop-blur-sm rounded-xl p-6 hover:bg-gray-700/70 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl ${
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {project.tags.map((tag, tagIndex) => (
                <span
                  key={tagIndex}
                  className="text-xs font-medium text-gray-300 bg-gray-600/50 px-3 py-1 rounded-full hover:bg-blue-500/20 hover:text-blue-300 transition-colors"
                >
                  {tag}
                </span>
              ))}
